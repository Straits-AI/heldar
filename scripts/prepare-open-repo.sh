...
[dependencies]
heldar-kernel = { path = "../heldar-kernel", version = "0.1.1" }
heldar-entry = { path = "../heldar-entry", version = "0.1.1" }
heldar-movement = { path = "../heldar-movement", version = "0.1.1" }
heldar-search = { path = "../heldar-search", version = "0.1.1" }
