//! VisionOps Access Control — generic, **open (Apache-2.0)** reference app.
//!
...
//! purely through public seams: [`visionops_kernel::services::consumer::DetectionConsumer`] (the ANPR
...
//!
//! Vertical/client products (e.g. a proprietary `visionops-campus-entry` adding students/guardians,
